 ...
 */
 ?>
    ...
    <a href="#" class="btn button-icon" id="top"><i><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none"><path d="M10.9996 17.3889V4.94446M10.9996 4.94446L4.77734 11.1667M10.9996 4.94446L17.2218 11.1667" stroke="#7A3D01" stroke-width="1.5" stroke-linecap="square" stroke-linejoin="round"/></svg></i></a>
    ...
    <?php include(locate_template('inc/components/modal-default.php'));?>
